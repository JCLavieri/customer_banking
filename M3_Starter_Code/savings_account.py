...
def create_savings_account(balance, interest_rate, months):
    ...
    # Pass the updated balance to the set balance method using the instance of the SavingsAccount class.
    account.set_balance(updated_balance)

    # Pass the interest earned to the set interest method using the instance of the SavingsAccount class.
