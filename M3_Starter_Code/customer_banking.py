...
def main():
    ...
    savings_maturity = int(input("Enter number of months: "))
    ...
    cd_maturity = int(input("Enter number of months: "))

    # Call the create_cd_account function and pass the variables to the function used to prompt the user.
